package com.example.zy.lucautils.app;
...
public class Constants {
    ...
    public static final int TYPE_DAILY = 111;

    public static final int TYPE_HOT = 112;

    public static final int TYPE_SECTION = 113;

    public static final int TYPE_THEME = 114;
